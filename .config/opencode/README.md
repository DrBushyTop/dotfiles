...
cp -r /Users/pasi/.config/opencode/context ~/.opencode/
```
...
**Context-aware:** Agents automatically load patterns from `/Users/pasi/.config/opencode/context/` to follow your coding standards.
...
nano ~//Users/pasi/.config/opencode/context/project/project-context.md
...
A: Edit `~//Users/pasi/.config/opencode/context/project/project-context.md` - agents automatically load this file.
